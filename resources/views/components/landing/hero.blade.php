    ...
    <div class="landing-container">
        <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div class="reveal order-2 lg:order-1">
                <p class="section-label mb-4 justify-center lg:justify-start">{{ __('landing.hero_badge') }}</p>
                <h1 id="hero-heading" class="hero-title text-balance text-center lg:text-left">
                    {{ __('landing.hero_title') }}
                    <span class="hero-gradient-text block sm:inline">{{ __('landing.hero_title_accent') }}</span>
                </h1>
                ...
                <ul class="mt-10 flex flex-wrap items-center justify-center gap-6 lg:justify-start">
                    <li class="flex items-center gap-2 text-sm text-ink-muted">
                        ...
                        <span><strong class="text-ink">12,000+</strong> {{ __('landing.hero_events') }}</span>
                    </li>
                    <li class="flex items-center gap-2 text-sm text-ink-muted">
                        ...
                        <span>{{ __('landing.hero_live_rsvp') }}</span>
                    </li>
                </ul>
            </div>
