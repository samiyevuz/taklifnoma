...
@php
    $eventDate = '2026-09-22T18:00:00+05:00';
    $mapLat = 41.311081;
    $mapLng = 69.240562;
    $mapUrl = "https://www.google.com/maps/search/?api=1&query={$mapLat},{$mapLng}";
    $yandexUrl = "https://yandex.com/maps/?pt={$mapLng},{$mapLat}&z=16&l=map";
...
@section('body')
    <div class="invitation-page" id="invitation-app">
        ...
        <audio id="inv-audio" loop preload="none">
            <source src="{{ asset('audio/wedding-ambient.mp3') }}" type="audio/mpeg">
        </audio>
        ...
        <main class="invitation-content" id="main-content">
            ...
            <section class="inv-welcome" id="inv-welcome" aria-label="Xush kelibsiz">
                ...
                <p class="inv-welcome__pre">Nikoh To'yi</p>
                <h1 class="inv-welcome__names">
                    Ali
                    <span class="inv-welcome__amp">&</span>
                    Vali
                </h1>
                <p class="inv-welcome__date">22 Sentabr 2026 · Toshkent</p>
            ...
            {{-- SECTION 2: Invitation Text & Countdown --}}
            <section class="inv-section" id="inv-details" aria-labelledby="inv-details-title">
                <div class="inv-reveal">
                    ...
                    <div class="inv-text-card inv-glass">
                        <p>
                            Hurmatli mehmon! Hayotimizning eng muborak kunida — nikoh to'yimizda
                            bizni sharaf bilan quvvatlashishingizni chin qalbdan so'raymiz.
                        </p>
                        <p>
                            Sizning iliq tilaklaringiz va qatnashuvingiz biz uchun eng katta baxt.
                            Marosimimizda sizni kutib qolamiz.
                        </p>
                        <p class="mt-4 font-serif text-inv-ink">
                            Oila nomidan — <em>Ali & Vali oilalari</em>
                        </p>

                        <div class="inv-countdown" id="inv-countdown" data-target="{{ $eventDate }}" role="timer" aria-live="polite">
            ...
            <section class="inv-section" id="inv-dresscode" aria-labelledby="inv-dress-title">
                <div class="inv-reveal">
                    ...
                    <p class="inv-dress-note" id="inv-dress-note" aria-live="polite">{{ $dressColors[0]['note'] }}</p>
                </div>
            </section>
            ...
            <section class="inv-section" id="inv-rsvp" aria-labelledby="inv-rsvp-title">
                <div class="inv-reveal">
                    ...
                    <form class="inv-rsvp-form inv-glass" id="inv-rsvp-form" novalidate>
                        ...
                        <div class="inv-field">
                            ...
                            <input type="text" id="rsvp-name" name="name" placeholder="To'liq ismingiz" required autocomplete="name">
                        </div>
                        ...
                        <div class="inv-field" id="rsvp-guests-field">
                            ...
                            <input type="hidden" name="adults" id="rsvp-adults" value="1">
                        </div>
                        ...
                        <div class="inv-field" id="rsvp-children-field">
                            ...
                            <input type="hidden" name="children" id="rsvp-children" value="0">
                        </div>

                        <button type="submit" class="inv-submit" id="inv-submit">
                            Tasdiqlash
                        </button>
                    </form>
            ...
            <section class="inv-section" id="inv-location" aria-labelledby="inv-location-title">
                <div class="inv-reveal">
                    ...
                    <div class="inv-location-card inv-glass">
                        <p class="inv-location-card__venue">Muhtasham To'yxonasi</p>
                        <p class="inv-location-card__address">Toshkent sh., Amir Temur ko'chasi 108</p>
        ...
        <div class="inv-map-modal" id="inv-map-modal" aria-hidden="true" role="dialog" aria-labelledby="inv-map-modal-title">
            <div class="inv-map-modal__sheet">
                <h3 id="inv-map-modal-title" class="font-serif text-lg font-semibold text-inv-ink text-center">
                    Navigatsiya
                </h3>
                <p class="mt-2 text-center text-sm text-inv-ink-soft">Muhtasham To'yxonasi, Toshkent</p>
                <div class="inv-map-modal__actions">
                    <a href="{{ $mapUrl }}" target="_blank" rel="noopener noreferrer" class="inv-map-modal__link">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                        </svg>
                        Google Maps
                    </a>
                    <a href="{{ $yandexUrl }}" target="_blank" rel="noopener noreferrer" class="inv-map-modal__link" style="background: linear-gradient(135deg, #fc3f1d, #ff6b4a); color: white;">
                        Yandex Xarita
                    </a>
