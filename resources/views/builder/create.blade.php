    ...
    <div class="landing-page relative min-h-dvh pt-24 pb-16">
        ...
        <div class="relative z-10 landing-container max-w-3xl">
            <div class="mb-8 text-center">
                ...
                <h1 class="font-serif text-display font-semibold text-ink">Taklifnoma Yaratish</h1>
                <p class="mt-3 text-ink-soft">Nikoh To'yi Premium shablonini to'ldiring va mehmonlarga ulashing.</p>
            </div>
